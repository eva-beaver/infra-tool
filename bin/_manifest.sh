...
function loadManifest {
    ...
    MANIFEST_TYPE_DOCKERCOMPOSE_TEMPLATEDIRECTORY=$(getJsonItem $MANIFEST_NAME '.dockerCompose.templateDirectory' $MANIFEST_TYPE_DOCKERCOMPOSE_TEMPLATEDIRECTORY)
...
function printManifest {
    ...
    echo "dockerCompose.templateDirectory [$MANIFEST_TYPE_DOCKERCOMPOSE_TEMPLATEDIRECTORY]"
